...
class _GoalCardState extends State<GoalCard> {
  ...
  Widget build(BuildContext context) {
    widget.todayStudyTime = 756;
    print("todayGoalTime");
    print(widget.todayStudyTime);
    return Container(
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        _buildTimeRow(
                          ...
                          _formatTime(
                              widget.weekStudyTime + widget.todayStudyTime),
                          Colors.green[100]!,
                        ),
                      ],
                    ),
  ...
  Future<void> _saveGoalTimes(int todayGoal, int weekGoal) async {
    try {
      ...
      await firestore.collection('WeeklySummary').doc(weeklyGoalId).update({
        'targetStudyTime': weekGoal,
      });

      // UserDailyGoals の targetStudyTime を更新
      await firestore.collection('DailySummary').doc(dailyGoalId).update({
